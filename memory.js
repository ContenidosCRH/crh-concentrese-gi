App = function()
{
    ...
    this.load = function()
    {
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/back2.jpg');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/a1.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/a2.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/b1.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/b2.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/c1.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/c2.png'); 
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/d1.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/d2.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/e1.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/e2.png');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/bg2.jpg');
        wade.loadImage('https://github.com/ContenidosCRH/crh-concentrese-gi/images/sparkle.png');
        wade.preloadAudio('https://github.com/ContenidosCRH/crh-concentrese-gi/sounds/right.ogg');
        wade.preloadAudio('https://github.com/ContenidosCRH/crh-concentrese-gi/sounds/wrong.ogg');
    };
    ...
    this.createCard = function(i, j, delay)
    {
        ...
        setTimeout(function()
        {
            ...
            var sprite = new Sprite('https://github.com/ContenidosCRH/crh-concentrese-gi/images/back2.jpg', 5);
            ...
            var animalSprite = new Sprite('https://github.com/ContenidosCRH/crh-concentrese-gi/images/' + index + '.png', 10);
            ...
            card.onMouseUp = function()
            {
                ...
                else if (hiddenCards.length == 1)   // there is 1 card currently hidden
                {
                    ...
                    if (hiddenCards[0].animalIndex.substring(0, 1) == hiddenCards[1].animalIndex.substring(0, 1))
                    {
                        ...
                        wade.playAudioIfAvailable('https://github.com/ContenidosCRH/crh-concentrese-gi/sounds/right.ogg');
                        if (++numMatches == 5)
                        {
                            setTimeout(function()
                            {
                    ...
                    else
                    {
                        ...
                        wade.playAudioIfAvailable('https://github.com/ContenidosCRH/crh-concentrese-gi/sounds/wrong.ogg');
                        setTimeout(function()
                        {
    ...
    this.createParticle = function(position)
    {
        ...
        var animation = new Animation('https://github.com/ContenidosCRH/crh-concentrese-gi/images/sparkle.png', 8, 4, 30);
